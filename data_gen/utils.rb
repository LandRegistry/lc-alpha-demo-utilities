...
$counties = ["Bath and NE Somerset", "Bedford", "Blackburn with Darwen", "Blackpool", "Bournemouth", "Bracknell Forest", "Brighton & Hove", "Bristol", "Buckinghamshire", "Cambridgeshire",
    "Central Bedfordshire", "Cheshire East", "Cheshire West & Chester", "Cornwall ", "County Durham", "Cumbria", "Darlington", "Derby ", "Derbyshire", "Devon", "Dorset", "East Riding of Yorkshire",
    "East Sussex", "Essex", "Gloucestershire", "Greater London", "Greater Manchester", "Halton", "Hampshire", "Hartlepool", "Herefordshire", "Hertfordshire", "Isle of Wight", "Kent",
    "Kingston upon Hull ", "Lancashire", "Leicester", "Leicestershire", "Lincolnshire", "Luton", "Medway", "Merseyside", "Middlesbrough", "Milton Keynes", "Norfolk", "North East Lincolnshire",
    "North Somerset", "North Yorkshire", "Northamptonshire", "Northumberland", "Nottingham", "Nottinghamshire", "Oxfordshire", "Peterborough", "Plymouth", "Poole", "Portsmouth", "Reading",
    "Redcar and Cleveland", "Rutland", "Salop", "Slough", "Somerset", "South Gloucestershire", "South Yorkshire", "Southampton", "Southend on Sea", "Staffordshire", "Stockton on Tees",
    "Stoke on Trent", "Suffolk", "Surrey", "Swindon", "Thurrock", "Torbay", "Tyne and Wear", "Warrington", "Warwickshire", "West Berkshire", "West Midlands", "West Sussex", "West Yorkshire",
    "Wiltshire", "Windsor & Maidenhead", "Wokingham", "Worcestershire", "Wrekin", "York", "Blaenau Gwent", "Bridgend", "Caerphilly", "Cardiff", "Carmarthenshire", "Ceredigion", "Conwy",
    "Denbighshire", "Flintshire", "Gwynedd", "Isle of Anglesey", "Merthyr Tydfil", "Monmouthshire", "Neath Port Talbot", "Newport", "Pembrokeshire", "Powys", "Rhondda Cynon Taff", "Swansea",
...
def fake_conveyancer
    name = ""
    case rand(1..4)
    when 1
        name = Faker::Name.first_name + " " + Faker::Name.last_name
    when 2
        name = random_letter + " & " + random_letter
    when 3
        name = Faker::Name.last_name + " & " + Faker::Name.last_name
    when 4
        name = Faker::Name.last_name + ", " + Faker::Name.last_name + " & " + Faker::Name.last_name
    when 5
        name = fake_company_name
    end

    suffixes = ["", "Associates", "Conveyancers", "Solicitors", "Group", "Legal Group"]
    (name + " " + suffixes.sample).strip
end
...
def create_bankruptcy_record(allow_withheld = true)
    ...
    # key number
    data['key_number'] = fake_key_number
